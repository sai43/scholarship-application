...
-I will add a "raffle" page to raffle from the list of users who are registered and completed an application to win. They will then be notified by an automated e-mail.

Automatic testing

Gems That Will be Used (Tentativee):
